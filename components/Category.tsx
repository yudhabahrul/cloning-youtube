...
const Category = ({ sidebarIsActive }: MixType) => {
  return (
    ...
    >
      <li
        title="Semua"
        className="text-gray-800 min-w-fit cursor-pointer font-medium text-[0.94rem] md:text-[0.85rem] bg-white p-[0.2rem] px-3 rounded-3xl"
      >
        Semua
      </li>
      <li
        title="Video Mix"
        className="text-slate-200 min-w-fit cursor-pointer transition duration-200 hover:bg-gray-600/90 text-[0.94rem] md:text-[0.85rem] font-medium bg-gray-600/50 p-[0.2rem] px-3 rounded-3xl border-[1px] border-gray-600"
      >
        Video Mix
      </li>
      <li
